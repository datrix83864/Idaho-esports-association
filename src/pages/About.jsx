  ...
  return (
    <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16">
      ...
      <div className="text-center space-y-4">
        <h1 className="text-4xl md:text-6xl font-bold text-white">About Idaho Esports</h1>
        <p className="text-xl text-gray-300 max-w-3xl mx-auto">
          We're building the future of competitive gaming in Idaho, one tournament at a time.
        </p>
      </div>
        ...
        <div className="flex items-start space-x-4 mb-6">
          ...
          <div>
            ...
            <p className="text-xl text-gray-200 leading-relaxed">
              To provide accessible, fair, and competitive esports opportunities for all Idaho students 
              while fostering sportsmanship, teamwork, and personal growth through gaming.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="bg-slate-800/50 backdrop-blur-sm border border-purple-500/30 rounded-xl p-6">
            ...
            <p className="text-gray-400">
              Fair play, transparent operations, and honest communication are the foundation 
              of everything we do.
            </p>
          </div>
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm border border-purple-500/30 rounded-xl p-6">
            ...
            <p className="text-gray-400">
              Esports is for everyone. We create welcoming spaces where all students can 
              compete regardless of skill level or background.
            </p>
          </div>
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm border border-purple-500/30 rounded-xl p-6">
            ...
            <p className="text-gray-400">
              We're committed to continuous improvement, both in our organization and in 
              helping students develop as competitors and individuals.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-slate-800/50 backdrop-blur-sm border border-purple-500/30 rounded-xl p-8 md:p-12">
        ...
        <div className="space-y-4 text-gray-300 leading-relaxed">
          <p>
            Idaho Esports Association was founded by passionate educators and gamers who saw 
            the incredible potential of competitive gaming to engage students, teach valuable 
            life skills, and create community connections across our state.
          </p>
          <p>
            What started as informal tournaments between a handful of schools has grown into 
            a statewide organization supporting dozens of schools and hundreds of student athletes. 
            We've watched students who were shy or disengaged find their voice and their community 
            through esports.
          </p>
          <p>
            As a non-profit organization, every dollar we receive goes directly back into 
            supporting our tournaments, providing resources for schools, and growing the 
            Idaho esports community. We're grateful for the support of our sponsors, volunteers, 
            and most importantly, the students and educators who make this all possible.
          </p>
        </div>
      </div>
      ...
      <div className="space-y-8">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-slate-800/50 backdrop-blur-sm border border-purple-500/30 rounded-xl p-6">
            ...
            <h3 className="text-xl font-bold text-white mb-3">Organize Tournaments</h3>
            <p className="text-gray-400 mb-4">
              We run regular competitive tournaments across multiple games, providing structured 
              competition for Idaho schools.
            </p>
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm border border-purple-500/30 rounded-xl p-6">
            ...
            <h3 className="text-xl font-bold text-white mb-3">Support Schools</h3>
            <p className="text-gray-400 mb-4">
              We help schools start and grow their esports programs with resources, guidance, 
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm border border-purple-500/30 rounded-xl p-6">
            ...
            <p className="text-gray-400 mb-4">
              We foster connections between players, coaches, and schools across Idaho through 
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm border border-purple-500/30 rounded-xl p-6">
            ...
            <h3 className="text-xl font-bold text-white mb-3">Advocate for Esports</h3>
            <p className="text-gray-400 mb-4">
              We work to increase recognition and support for esports programs in Idaho 
      ...
      <div className="bg-purple-900/30 border-l-4 border-purple-500 rounded-xl p-8">
        <h2 className="text-2xl font-bold text-purple-300 mb-4">Our Non-Profit Commitment</h2>
        ...
        <ul className="space-y-2 text-gray-300 mb-6">
          ...
          <li className="flex items-start space-x-3">
            <span className="text-purple-400 mt-1">✓</span>
            <span>Donations are tax-deductible to the fullest extent allowed by law</span>
          </li>
          <li className="flex items-start space-x-3">
            <span className="text-purple-400 mt-1">✓</span>
      ...
      <div className="bg-slate-800/50 backdrop-blur-sm border border-purple-500/30 rounded-xl p-8 text-center">
        ...
        <p className="text-gray-300 mb-8">
          Whether you're a student, educator, sponsor, or supporter, there's a place for you 
          in the Idaho esports community.
        </p>
