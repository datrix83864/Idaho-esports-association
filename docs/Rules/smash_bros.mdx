...
- P1: Winning crew of set 2
- P2: Losing crew of set 2
...
- The map stays the same for all players in the set

### 2.6. Match Reporting

- Scores are reported as Stockes taken for both sides
  - One team should score 12 points
