...
- Teams are allowed to reschedule provided both teams agree to the agreed upon date and time. This must be communicated from both coaches to IEA, preferably by using the Discord chat.
